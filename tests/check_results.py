"""Common result tests for each method of updating Batterie object
"""
import datetime
...
def check_results(battery_charging: Batterie, battery_discharging: Batterie):
    ...
    print(f'remaining_charge: {remaining_charge:,2f}  battery_full_charge_capacity_wh: {battery_charging.battery_full_charge_capacity_wh:,2f}  battery_remaining_capacity_wh: {battery_charging.battery_remaining_capacity_wh}')
    seconds = int(remaining_charge / battery_charging.charging) * 3600 if battery_charging.charging else None
    print(f'charging: {battery_charging.charging}  seconds: {seconds}')
